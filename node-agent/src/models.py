...
class ConnectionReport(BaseModel):
    ...
    inbound_tag: str = ""
    # Аутбаунды, которые Xray выбрал для этого подключения за кусок лога —
    # вторая половина скобок [inbound -> outbound] в access.log. Список, а не
    # один тег: за батч человек уходит в несколько веток сразу.
