...
### База данных (23 миграции Alembic)
...
4. **Фаза 12.2** — i18n бэкенда: коды ошибок, i18n шаблонов автоматизаций/уведомлений
5. **Фаза 14** — бэкап: экспорт/импорт конфигурации, pg_dump/pg_restore из панели
6. **Фаза 15** — внешний API: API-ключи, webhook-подписки, SDK, документация
