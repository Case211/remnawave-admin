...
Обязательных немного — всё остальное имеет разумные значения по умолчанию. Большинство настроек меняется прямо в интерфейсе панели без перезапуска; `.env` для них — начальное значение.
