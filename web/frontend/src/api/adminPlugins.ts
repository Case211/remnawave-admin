...
export interface CatalogPlugin {
  ...
  purchasable?: boolean
  /**
   * Плагин бесплатный: цены нет вовсе, подписка не нужна, wheel отдаётся
   * любой привязанной панели. Не путать с `purchasable: false` — там
   * «временно не продаём», здесь «покупать нечего».
   */
  free?: boolean
