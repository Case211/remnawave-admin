"""Монитор расхода трафика — отслеживание аномально высокого потребления.
...
Считается именно ОБЪЁМ за окно, а не скорость канала: порог задаётся в
гигабайтах, и «10 ГБ за час» ничего не говорит о мгновенных мегабитах.
Раньше это звалось «монитором скорости трафика» и обещало не то. Ключи
