...
# пересобирает на ноде наше ifb-устройство и фильтры, и на это мгновение
# ограничение с наказанных спадает, а старые агенты заодно переставляли
# корень интерфейса — дёргать ноду незачем, пока список не изменился.
