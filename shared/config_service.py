...
DEFAULT_CONFIG_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "category": "general",
        "subcategory": "logs",
        "display_name": "Хранение журнала аудита (дни)",
        "description": "Сколько дней хранить записи журнала аудита. 0 — бессрочно",
        "default_value": "0",
        "sort_order": 5,
    },
    {
        ...
        "category": "general",
        "subcategory": "logs",
        "display_name": "Хранение уведомлений (дни)",
        "description": "Сколько дней хранить уведомления и журнал срабатываний алертов",
        "default_value": "90",
        "sort_order": 6,
    },
    {
    ...
    },
    {
        ...
        "description": (
            "Зона IANA, например Europe/Moscow. В ней показывается всё время: веб-панель, "
            "бот, уведомления, выгрузки и время отчётов. В базе время хранится в UTC"
        ),
    ...
    {
        "key": "notifications_users_enabled",
        "value_type": "bool",
        "category": "notifications",
        "subcategory": "types",
        "display_name": "Уведомления: Пользователи",
        "description": "Отправлять Telegram-уведомления о пользователях",
        "default_value": "true",
        "sort_order": 20,
    },
    {
        "key": "notifications_nodes_enabled",
        "value_type": "bool",
        "category": "notifications",
        "subcategory": "types",
        "display_name": "Уведомления: Ноды",
        "description": "Отправлять Telegram-уведомления о нодах",
        "default_value": "true",
        "sort_order": 21,
    },
    {
        "key": "notifications_service_enabled",
        "value_type": "bool",
        "category": "notifications",
        "subcategory": "types",
        "display_name": "Уведомления: Сервис",
        "description": "Отправлять сервисные Telegram-уведомления",
        "default_value": "true",
        "sort_order": 22,
    },
    {
        "key": "notifications_hwid_enabled",
        "value_type": "bool",
        "category": "notifications",
        "subcategory": "types",
        "display_name": "Уведомления: HWID",
        "description": "Отправлять Telegram-уведомления о HWID-устройствах",
        "default_value": "true",
        "sort_order": 23,
    },
    {
        "key": "notifications_crm_enabled",
        "value_type": "bool",
        "category": "notifications",
        "subcategory": "types",
        "display_name": "Уведомления: CRM",
        "description": "Отправлять Telegram-уведомления CRM и биллинга инфраструктуры",
        "default_value": "true",
        "sort_order": 24,
    },
    {
        "key": "notifications_errors_enabled",
        "value_type": "bool",
        "category": "notifications",
        "subcategory": "types",
        "display_name": "Уведомления: Ошибки",
        "description": "Отправлять Telegram-уведомления об ошибках",
        "default_value": "true",
        "sort_order": 25,
    },
    {
        "key": "notifications_violations_enabled",
        "value_type": "bool",
        "category": "notifications",
        "subcategory": "types",
        "display_name": "Уведомления: Нарушения",
        "description": "Отправлять Telegram-уведомления о нарушениях",
        "default_value": "true",
        "sort_order": 26,
    },
    {
        "key": "notifications_finance_enabled",
        "value_type": "bool",
        "category": "notifications",
        "subcategory": "types",
        "display_name": "Уведомления: Финансы",
        "description": "Отправлять финансовые Telegram-уведомления и напоминания",
        "default_value": "true",
        "sort_order": 27,
    },
    {
    ...
    {
        "key": "notifications_topic_crm",
        "value_type": "int",
        "category": "notifications",
        "subcategory": "topics",
        "display_name": "Топик: CRM",
        "description": "ID топика для CRM и биллинга инфраструктуры",
        "env_var_name": "NOTIFICATIONS_TOPIC_CRM",
        "sort_order": 14,
    },
    {
    ...
    {
        "key": "support_media_cache_enabled",
        "value_type": "bool",
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: кэш вложений",
        "description": "Хранить скачанные вложения на диске, чтобы не ходить за ними к боту каждый раз",
        "default_value": "true",
        "sort_order": 56,
    },
    {
        "key": "support_media_cache_days",
        "value_type": "int",
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: срок хранения вложений",
        "description": "Через сколько дней без обращений файл удаляется; старый тикет скачает его заново",
        "default_value": "14",
        "sort_order": 57,
    },
    {
        "key": "support_media_cache_max_mb",
        "value_type": "int",
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: потолок кэша вложений (МБ)",
        "description": "При превышении удаляются самые давно не открывавшиеся файлы (0 — без лимита)",
        "default_value": "2048",
        "sort_order": 58,
    },
    {
    ...
    },
    {
        ...
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: срок первого ответа",
        "description": "Через сколько минут ожидания обращение считается просроченным",
        "default_value": "30",
        "sort_order": 60,
    },
    {
        "key": "support_alerts_enabled",
        "value_type": "bool",
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: алерты",
        "description": "Уведомлять о новых обращениях и о просрочке первого ответа",
        "default_value": "true",
        "sort_order": 61,
    },
    {
        "key": "support_alert_new_ticket",
        "value_type": "bool",
        "category": "general",
        "subcategory": "support",
    ...
    },
    {
        ...
        "description": "Когда клиента блокируют или режут ему скорость — вручную или "
                       "автоматически, — отправлять ему объяснение, иначе он приходит "
                       "в поддержку с «у меня не работает»",
        "default_value": "true",
        "sort_order": 12,
    },
    {
    ...
    },
    {
        ...
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: автоответ в часы тишины",
        "description": "Отвечать клиенту сразу, пока оператор спит. Один ответ на обращение; "
                       "ожидание и метрика первого ответа его не засчитывают",
        "default_value": "false",
        "sort_order": 63,
    },
    {
        ...
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: текст автоответа",
        "description": "{id} подставит номер обращения, {until} — час, когда оператор снова на связи. "
                       "Пишите честно: обещание ответить через час ночью хуже молчания",
        "default_value": "Здравствуйте! Обращение №{id} принято — это автоматический ответ. "
                         "Оператор на связи с {until}, тогда и разберём.",
        "sort_order": 64,
    },
    {
        "key": "support_quiet_hours_start",
        "value_type": "string",
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: часы тишины с",
        "description": "Время в формате ЧЧ:ММ, когда оператора уже нет на месте",
        "default_value": "22:00",
        "sort_order": 65,
    },
    {
        "key": "support_quiet_hours_end",
        "value_type": "string",
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: часы тишины до",
        "description": "Время в формате ЧЧ:ММ, когда оператор снова на связи",
        "default_value": "08:00",
        "sort_order": 66,
    },
    {
        "key": "support_quiet_hours_tz",
        "value_type": "string",
        "category": "general",
        "subcategory": "support",
        "display_name": "Поддержка: часовой пояс тишины",
        "description": "Своя зона IANA для часов тишины, например Europe/Moscow. Пусто — общий часовой пояс панели",
        "default_value": "",
        "sort_order": 67,
    },
    {
        ...
        "category": "backup",
        "subcategory": "s3",
        "display_name": "S3: адрес хранилища",
        "description": "Например https://s3.timeweb.cloud или https://s3.storage.selcloud.ru",
        "default_value": "",
        "sort_order": 10,
    },
    {
        ...
        "category": "backup",
        "subcategory": "s3",
        "display_name": "S3: бакет",
        "description": "Имя бакета, куда складывать файлы бэкапов",
        "default_value": "",
        "sort_order": 11,
    },
    {
        ...
        "category": "backup",
        "subcategory": "s3",
        "display_name": "S3: регион",
        "description": "Регион для подписи запроса: us-east-1, ru-1, ru-central1 и т.п.",
    ...
    },
    {
        ...
        "category": "backup",
        "subcategory": "s3",
        "display_name": "S3: папка",
        "description": "Префикс ключа внутри бакета, пусто — класть в корень",
        "default_value": "",
        "sort_order": 13,
    },
    {
        "key": "backup_s3_path_style",
        "value_type": "bool",
        "category": "backup",
        "subcategory": "s3",
        "display_name": "S3: path-style адреса",
        "description": "Адрес вида endpoint/bucket/key — нужен MinIO и большинству российских провайдеров",
        "default_value": "true",
        "sort_order": 14,
    },
    {
        "key": "backup_s3_auto_upload",
        "value_type": "bool",
        "category": "backup",
        "subcategory": "s3",
        "display_name": "S3: выгружать автоматически",
        "description": "Отправлять в хранилище каждый бэкап, созданный по расписанию",
        "default_value": "false",
        "sort_order": 15,
    },
    {
        "key": "backup_s3_keep_count",
        "value_type": "int",
        "category": "backup",
        "subcategory": "s3",
        "display_name": "S3: хранить файлов",
        "description": "Сколько последних файлов оставлять в бакете при автовыгрузке (0 = не чистить)",
        "default_value": "0",
        "sort_order": 16,
    },
    {
        ...
        "category": "backup",
        "subcategory": "s3",
        "display_name": "S3: ключи доступа",
        "description": "Access Key и Secret Key, зашифрованы; правятся только через раздел бэкапов",
        "default_value": "",
        "is_secret": True,
        "is_readonly": True,
        "sort_order": 17,
    ...
    # мгновенно, как ставится.
    {
        ...
        "description": "Разрешить «мягкую блокировку» — резать скорость нарушителю вместо полного отключения. Требует агента 1.7.0+ на нодах; с агентом 1.9.0 режет шейпер ноды, в обе стороны",
        "default_value": "true",
        "sort_order": 60,
    },
    {
        ...
        "description": "На сколько резать, если скорость не указана явно. 0 или пусто — без лимита: кнопка в боте и автодействия ничего не урезают. 1024 — сайты и мессенджеры работают, видео и торренты нет: человек замечает, что интернет странный, и идёт разбираться, а не молча теряет доступ",
        "default_value": "1024",
        "sort_order": 61,
    },
    {
    ...
    },
    {
        ...
        "display_name": "Отложенное применение мер",
        "description": "Создавать долговечные кейсы: предупредить, выждать срок, перепроверить и применить выбранное действие.",
        "default_value": "false",
        "sort_order": 50,
    },
    {
        ...
        "category": "violations",
        "subcategory": "enforcement",
        "display_name": "Режим выполнения",
        "description": "dry_run — только моделирование; deliver_only — отправка без меры; enforce — выбранная мера после срока.",
        "default_value": "dry_run",
        "options": ["dry_run", "deliver_only", "enforce"],
        "sort_order": 51,
    },
    {
        "key": "enforcement_grace_hours",
        "value_type": "int",
        "category": "violations",
        "subcategory": "enforcement",
        "display_name": "Срок на ответ (часы)",
        "description": "Сколько часов дать пользователю после предупреждения.",
        "default_value": "12",
        "sort_order": 51,
    },
    {
        ...
        "category": "violations",
        "subcategory": "enforcement",
        "display_name": "Какие нарушения предупреждать",
        "description": "trial_only — только абьюз бесплатных триалов; all_hard_blocks — все нарушения с рекомендацией жёсткой блокировки.",
        "default_value": "trial_only",
        "options": ["trial_only", "all_hard_blocks"],
        "sort_order": 51,
    },
    {
        "key": "enforcement_min_score", "value_type": "float",
        "category": "violations", "subcategory": "enforcement",
        "display_name": "Минимальный скор", "description": "Не создавать кейс ниже этого скора.",
        "default_value": "0", "sort_order": 52,
    },
    {
        "key": "enforcement_final_action",
        "value_type": "string",
        "category": "violations",
        "subcategory": "enforcement",
        "display_name": "Действие по истечении срока",
        "description": "manual_review — оставить администратору, disable — отключить, throttle — ограничить скорость, none — завершить без меры.",
        "default_value": "manual_review",
        "options": ["manual_review", "disable", "throttle", "none"],
        "sort_order": 52,
    },
    {
        "key": "enforcement_pilot_user_uuids",
        "value_type": "json",
        "category": "violations",
        "subcategory": "enforcement",
        "display_name": "Пилотные UUID пользователей",
        "description": "Если список не пуст, workflow применяется только к указанным UUID.",
        "default_value": "[]",
        "sort_order": 53,
    },
    {
        "key": "enforcement_notice_suffix", "value_type": "string",
        "category": "violations", "subcategory": "enforcement",
        "display_name": "Текст срока и последствия",
        "description": "Добавляется к шаблону предупреждения. Подстановки: {hours}, {deadline}, {action}.",
        "default_value": "У вас есть {hours} ч. до {deadline}, чтобы обратиться в поддержку. После этого будет применено действие: {action}.",
        "sort_order": 54,
    },
    {
        "key": "enforcement_pause_for_support",
        "value_type": "bool",
        "category": "violations",
        "subcategory": "enforcement",
        "display_name": "Пауза при обращении в поддержку",
        "description": "Останавливать ожидающую автоматическую меру, если пользователь обратился во встроенную или внешнюю поддержку.",
        "default_value": "true",
        "sort_order": 54,
    },
    {
        "key": "enforcement_delivery_failure",
        "value_type": "string",
        "category": "violations",
        "subcategory": "enforcement",
        "display_name": "Если предупреждение не доставлено",
        "description": "manual_review — передать оператору; continue — всё равно начать отсчёт; fail — завершить с ошибкой.",
        "default_value": "manual_review",
        "options": ["manual_review", "continue", "fail"],
        "sort_order": 55,
    },
    {
        "key": "enforcement_delivery_attempts", "value_type": "int",
        "category": "violations", "subcategory": "enforcement",
        "display_name": "Попытки доставки", "description": "Число попыток до применения правила ошибки доставки.",
        "default_value": "3", "sort_order": 56,
    },
    {
        "key": "enforcement_throttle_kbit", "value_type": "int",
        "category": "violations", "subcategory": "enforcement",
        "display_name": "Скорость ограничения (Кбит/с)",
        "description": "Используется, если итоговое действие — throttle.",
        "default_value": "1024", "sort_order": 57,
    },
    {
        "key": "enforcement_throttle_hours", "value_type": "int",
        "category": "violations", "subcategory": "enforcement",
        "display_name": "Срок ограничения (часы)",
        "description": "0 — до ручного снятия.",
    ...
    {
        "key": "violations_ip_trial_guard_enabled",
        "value_type": "bool",
        "category": "security",
        "subcategory": "user_blacklist",
        "display_name": "Сторож адресов: повторные пробные",
        "description": "Замечать адреса, с которых пробную подписку брали несколько раз разными аккаунтами. HWID называет сам клиент и подделывается заголовком, а адрес выдаёт провайдер — сменить его труднее. Служебные и операторские диапазоны (127.0.0.0/8, 100.64/10 и прочие приватные) не учитываются",
        "default_value": "true",
        "sort_order": 26,
    },
    {
        "key": "violations_ip_trial_accounts",
        "value_type": "int",
        "category": "security",
        "subcategory": "user_blacklist",
        "display_name": "Пробных подписок с одного адреса",
        "description": "Сколько разных пробных подписок с одного адреса допустимо без сигнала. Считаются только пробные: за адресом домашнего провайдера живёт целая квартира, и общее число аккаунтов само по себе ни о чём не говорит",
        "default_value": "2",
        "sort_order": 27,
    },
    {
        "key": "violations_ip_trial_accounts_mobile",
        "value_type": "int",
        "category": "security",
        "subcategory": "user_blacklist",
        "display_name": "То же для мобильных адресов",
        "description": "Отдельный порог для адресов мобильных операторов. Там CGNAT: за одним адресом сидит район, и несколько разных людей с пробными подписками — обычное дело, а не совпадение",
        "default_value": "4",
        "sort_order": 28,
    },
    {
        "key": "violations_ip_trial_window_days",
        "value_type": "int",
        "category": "security",
        "subcategory": "user_blacklist",
        "display_name": "Окно поиска по адресам (дней)",
        "description": "За какой период считать подключения. Слишком широкое окно собирает динамические адреса, которые за это время успели смениться у нескольких абонентов",
        "default_value": "30",
        "sort_order": 29,
    },
    {
        "key": "violations_ip_trial_repeat_hours",
        "value_type": "int",
        "category": "security",
        "subcategory": "user_blacklist",
        "display_name": "Не повторять сигнал по адресу (часов)",
        "description": "Сколько молчать про адрес после уведомления о нём",
        "default_value": "24",
        "sort_order": 30,
    },
    {
        "key": "violations_ip_trial_interval_minutes",
        "value_type": "int",
        "category": "security",
        "subcategory": "user_blacklist",
        "display_name": "Интервал сторожа адресов (мин)",
        "description": "Как часто пересматривать адреса. Проверка тяжелее HWID-сторожа: она группирует историю подключений за всё окно",
        "default_value": "60",
        "sort_order": 31,
    },
    {
        "key": "hwid_blacklist_guard_enabled",
        "value_type": "bool",
        "category": "security",
        "subcategory": "user_blacklist",
        "display_name": "Сторож чёрного списка HWID",
        "description": "Периодически проверять, не ожила ли подписка у тех, кого видели на устройстве из чёрного списка, и гасить её снова. Нужен потому, что блокировка разовая, а поднять подписку может что угодно уже после неё — например привязка telegram_id к заведённой через email. Записи с действием «оповещение» остаются наблюдением: про них только сообщение, подписку сторож не трогает",
        "default_value": "true",
        "sort_order": 24,
    },
    {
        "key": "hwid_blacklist_guard_interval_minutes",
        "value_type": "int",
        "category": "security",
        "subcategory": "user_blacklist",
        "display_name": "Интервал сторожа HWID (мин)",
        "description": "Как часто сторож обходит чёрный список HWID. Меньше интервал — короче окно, в которое воскресшая подписка успевает поработать",
        "default_value": "5",
        "sort_order": 25,
    },
    {
    ...
    # ── Детект атак на ноды (нужны сетевые метрики агента 1.3.0+) ──
    {
        "key": "attack_detect_enabled",
        "value_type": "bool",
        "category": "security",
        "subcategory": "node_attacks",
        "display_name": "Детект атак на ноды",
        "description": "Следить за сетевыми метриками нод и предупреждать, когда нода под атакой. Работает только с агентом 1.3.0+.",
        "default_value": "true",
        "sort_order": 30,
    },
    {
        "key": "attack_pps_ratio",
        "value_type": "float",
        "category": "security",
        "subcategory": "node_attacks",
        "display_name": "Порог по пакетам (× от обычного)",
        "description": "Во сколько раз входящий поток пакетов должен превысить обычный для этой ноды. Ниже 3 будут ложные срабатывания на вечерних пиках.",
        "default_value": "4",
        "sort_order": 31,
    },
    {
        "key": "attack_bps_ratio",
        "value_type": "float",
        "category": "security",
        "subcategory": "node_attacks",
        "display_name": "Порог по трафику (× от обычного)",
        "description": "То же самое, но для объёма входящего трафика — ловит атаки крупными пакетами.",
        "default_value": "4",
        "sort_order": 32,
    },
    {
        ...
        "category": "security",
        "subcategory": "node_attacks",
        "display_name": "Минимум пакетов/с для тревоги",
        "description": "Ниже этого значения всплеск игнорируется: на пустой ночной ноде рост «в десять раз» получается из шума.",
        "default_value": "5000",
        "sort_order": 33,
    },
    {
        ...
        "category": "security",
        "subcategory": "node_attacks",
        "display_name": "Минимум байт/с для тревоги",
        "description": "То же для объёма. По умолчанию 12 500 000 — это 100 Мбит/с.",
        "default_value": "12500000",
        "sort_order": 34,
    },
    {
        "key": "attack_min_samples",
        "value_type": "int",
        "category": "security",
        "subcategory": "node_attacks",
        "display_name": "Замеров для базлайна",
        "description": "Сколько замеров нужно накопить, прежде чем верить «обычному» уровню ноды. Пока меньше — детектор молчит.",
        "default_value": "20",
        "sort_order": 35,
    },
    {
        "key": "attack_small_packet_bytes",
        "value_type": "int",
        "category": "security",
        "subcategory": "node_attacks",
        "display_name": "Мелкий пакет, байт",
        "description": "Средний размер пакета ниже этого считается признаком флуда: полезный трафик состоит из пакетов покрупнее.",
        "default_value": "300",
        "sort_order": 36,
    },
]
